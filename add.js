...
function saveName() {
    ...
    if (nameInput) {
        ...
        if (nameInput.toLowerCase() === "abraham") {
            userName = nameInput;
            ...
            errorMsg.textContent = "your name is needed bruh! only you can open this shit!";
        }
    } else {
        ...
        errorMsg.style.display = "block";
        errorMsg.textContent = "Oga put your name Jare";
    }
}
...
"Long life and prosperity is what you will have",
"You are the best bro I can ever wish for",
"Well not the best cause I don suffer for your hand" ,
"But I believe it is because you love me",
"What is love without discipline, ",
"I know it is really tough being the first child",
"But trust me you are not alone",
"You have me, I fit talk say I hate you but deep down",
"I dont, you are one of a kind",
"you show me love in another language and I appreciate you for that",
"You have come a long way and this birthday of yours will bring good news and peace to you!",
